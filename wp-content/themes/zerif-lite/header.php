					...
					if(isset($zerif_logo) && $zerif_logo != ""):
						...
						echo '<a href="'.esc_url( home_url( '/' ) ).'" class="navbar-brand">';
							...
							if( file_exists(get_stylesheet_directory()."/images/logo.png")):
								...
								echo '<img src="'.get_stylesheet_directory_uri().'/images/logo.png" class="logo" alt="'.esc_attr( get_bloginfo('title') ).'">';
							
							else:
								
								echo '<img src="'.get_template_directory_uri().'/images/logo.png" class="logo" alt="'.esc_attr( get_bloginfo('title') ).'">';
